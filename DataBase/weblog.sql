...
--
-- Host: localhost
-- Generation Time: Jan 30, 2016 at 04:44 PM
...
INSERT INTO `commentaires` (`id`, `id_billet`, `author`, `content`, `date`, `modified`, `validated`) VALUES
(1, 1, 'PALAPAPAPAAAAA', 'j''ai modifi̩ trois fois !', '2016-01-20', '2016-01-30 14:39:33', 1),
(2, 1, 'test', 'test1', '2016-01-30', '2016-01-30 15:12:12', 1),
(3, 1, 'coucou nous', 'Coucou vous tous !', '2016-01-30', '2016-01-30 16:14:31', 1),
(4, 1, 'insert', 'into', '2016-01-30', '0000-00-00 00:00:00', 1);
...
INSERT INTO `users` (`id`, `droit`, `login`, `password`) VALUES
(1, 1, 'root', 'root'),
(3, 3, 'blog', 'blog'),
(4, 2, 'admin', 'admin'),
(5, 3, 'coucou', 'coucou'),
